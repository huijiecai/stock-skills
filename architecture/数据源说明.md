...
| **财报披露日程** | **`disclosure_date`** | https://tushare.pro/document/2?doc_id=162 | **需500积分** |
| **业绩快报(批量)** | **`express_vip`** | https://tushare.pro/document/2?doc_id=46 | **需5000积分** |
| **利润表(批量)** | **`income_vip`** | https://tushare.pro/document/2?doc_id=33 | **需5000积分** |
