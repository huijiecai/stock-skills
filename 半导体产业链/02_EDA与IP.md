...
| 公司 | 国家 | 强项 | 代表产品 |
|------|------|------|----------|
| **Synopsys** | 美国🇺🇸 | 数字前端、验证、IP | Design Compiler、VCS |
| **Cadence** | 美国🇺🇸 | 模拟设计、后端、PCB | Virtuoso、Innovus |
| **Siemens EDA** | 德国🇩🇪 | 验证、DFT、后端 | Calibre、Questa |
...
| 公司 | 代码 | 主营 | 市场地位 |
|------|------|------|----------|
| **华大九天** | 301269 | EDA工具 | 国产EDA龙头 |
| **概伦电子** | 688206 | EDA（建模仿真）| 细分龙头 |
| **芯原股份** | 688521 | IP授权 | 国产IP龙头 |
| **寒武纪** | 688256 | AI IP/芯片 | AI芯片+IP |
