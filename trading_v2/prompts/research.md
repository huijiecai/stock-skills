...
**归因——禁止方向标签**:"PCB涨停"是标签,"覆铜板涨价周期+中报业绩兑现"才是催化。必须联网搜索今天爆发的**具体催化源**(业绩公告?涨价数据?政策事件?),不可停留在方向标签,不可假设催化与之前相同而不搜索。搜索顺序:公司公告/年报 → 行业数据/政策 → 财经媒体/雪球/淘股吧。

统一归因法(四行):
1. **具体事件**:正在交易的公告/数据/政策/事件节点是什么?
