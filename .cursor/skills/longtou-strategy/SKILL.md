...
**命令**：`/longtou-strategy 回测分析` 或 `/longtou-strategy 历史回测`
...
```
## 赚钱模式TOP3
1. 早盘涨停+文化传媒：T+1收益+5.2%，胜率68%
2. 2-3板化工股：T+1收益+4.1%，胜率52%
...
> 💡 **从"规则驱动"到"数据驱动"**：让LLM自己从历史数据中发现规律
