...
| 数据查询API.md | 6类数据的详细查询方法、代码示例 |
| 数据库设计.md | 表结构、字段说明、关系设计 |
...
查看 reference/龙头战法理论.md 了解判断标准
  ↓
查看 reference/数据查询API.md 获取查询方法
  ↓
...
4. 在 reference/数据查询API.md 中补充文档
```
...
在 `query_service.py` 中添加新方法，然后更新 `reference/数据查询API.md`。
